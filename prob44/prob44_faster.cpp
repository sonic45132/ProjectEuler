...
bool check_sum(std::vector<long long>& pents, std::unordered_multimap<long long, pair>& sums, std::vector<pair>& matches)
{
	bool result = false;
...
void calc_sums(std::vector<long long>& pents, std::unordered_multimap<long long, pair>& sums)
{
...
// void clear_map(std::vector<long long>& pents, std::unordered_multimap<long long, pair>& sums)
// {
...
int main()
{
	...
	std::unordered_multimap<long long, pair> sums = {{3, {1, 2}}};
